...
![Créer des capteurs](/docs/img/Sensor-einrichten.jpg)
...
![Configurer les capteurs](/docs/img/Sensor-einstellungen.jpg)
...
En cliquant sur _save_, le capteur est créé puis affiché dans Dashboard sous _Sensors_.

![Capteurs Dashboard](/docs/img/Sensor-dashboard.jpg)
