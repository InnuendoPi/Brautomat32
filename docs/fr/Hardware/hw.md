...
Les exemples présentés ici ne sont qu’une petite sélection d’idées. Les liens pointent vers des contenus externes dont les fournisseurs respectifs sont responsables. Les liens ne sont liés à aucun programme d’affiliation, de trading ou similaire. Vous êtes invités à ajouter d’autres idées et images ici.
...
Une pompe est d'une grande aide lors de la filtration ou du transport vers la cuve de fermentation. La pompe utilisée doit être de qualité alimentaire et adaptée à des températures allant jusqu'à 100°C. Les mini-pompes de Rotekt conviennent parfaitement à une utilisation dans la cuisine de la brasserie :
...
Avec le Brautomat, les SSR peuvent être commutés très facilement. Les relais SSR ou statiques allument ou éteignent le circuit 220 V CA avec 3-5 V CC de Brautomat. Les relais statiques Fotek sont idéaux pour le contrôle de la température et le contrôle via le Brautomat.
...
Tous les consommateurs n’ont pas besoin d’un RSS puissant. Par exemple, les actionneurs tels que les agitateurs ou les pompes peuvent être commutés avec des cartes relais peu coûteuses. Une très bonne carte relais est la carte relais optocoupleur Keenso à 4 canaux.
