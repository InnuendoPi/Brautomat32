...
Os exemplos mostrados aqui são apenas uma pequena seleção de ideias. Os links apontam para conteúdos externos pelos quais os respectivos fornecedores são responsáveis. Os links não estão vinculados a nenhum programa de afiliados, negociação ou similar. Você está convidado a adicionar mais ideias e imagens aqui.

## Exemplos de atores

### Bombas

![Atores](/docs/img/Pumpe1.jpg)

Uma bomba é uma grande ajuda na hora de clarear ou transportar para o tanque de fermentação. A bomba utilizada deve ser adequada para alimentos e adequada para temperaturas até 100°C. As minibombas da Rotekt são muito adequadas para uso na cozinha da cervejaria:

![Atores](/docs/img/Pumpe2.jpg)
...
Com o Brautomat SSRs podem ser trocados facilmente. Relés SSR ou de estado sólido ligam ou desligam o circuito de 220 Vca com 3-5 Vcc de Brautomat. Os SSRs Fotek são ideais para controle de temperatura e controle via Brautomat.
...
Nem todos os consumidores precisam de um SSR poderoso. Por exemplo, atuadores como agitadores ou bombas podem ser comutados com placas de relé baratas. Uma placa de relé muito boa é a placa de relé do optoacoplador Keenso de 4 canais.

![keenso](/docs/img/keenso.jpg)

| Nome do item | Link para artigo |
| ------------------ | --------------------------------- |
| Placa de relé Keenso 4 canais | [amazon](https://www.amazon.de/dp/B07QKHPBVP/?coliid=IW0L994AVYJSX&colid=I7GQB171JGLX&psc=1&ref_=cm_sw_r_cp_ud_lstpd_1MYFTEN8WCBBE7AD4J7T) |
| Placa de relé Keenso 2 canais | [amazon](https://www.amazon.de/dp/B07PY7LF9Z/?coliid=IHJD818Z5259W&colid=I7GQB171JGLX&psc=1&ref_=cm_sw_r_cp_ud_lstpd_1MYFTEN8WCBBE7AD4J7T) |
