...
The following description uses an _example recipe_. The focus is not the recipe itself, but the workflow when brewing with the Brautomat.

The mash plan is a table that is processed from top to bottom. In the example, _Mash-in 50°C_ is the first step and _WHP Hallertauer Tradition_ is the last step. A key property is the `autonext` column.

## Basic Functions

![mashplan](../.gitbook/assets/brautomat.jpg)
...
![Edit mash plan](../.gitbook/assets/brautomat-111.jpg)
...
![Edit mash plan](../.gitbook/assets/brautomat-1.jpg)
...
![Edit mash plan](../.gitbook/assets/brautomat-11.jpg)
...
![Edit mash plan](../.gitbook/assets/brautomat-3.jpg)
...
![Edit mash plan](../.gitbook/assets/brautomat-4.jpg)

Edit controls are hidden. Pause the process to show edit controls again:

![Edit mash plan](../.gitbook/assets/brautomat-5.jpg)
...
![Mash plan autonext](../.gitbook/assets/Maischeplan-autonext.jpg)
...
![Mash plan autonext](../.gitbook/assets/Maischeplan-autonext2.jpg)
...
![Special function 0°C](../.gitbook/assets/Maischeplan-Sonderfunktion.jpg)
...
![Actuator control command](../.gitbook/assets/Maischeplan-Aktoren.jpg)
...
![IDS control command](../.gitbook/assets/aktoren_schalten4.jpg)
...
![IDS control command](../.gitbook/assets/aktoren_schalten2.jpg) ![IDS control command](../.gitbook/assets/aktoren_schalten3.jpg)

## Example: Decoction with Two Hobs

![IDS and SUD control command](../.gitbook/assets/sonderfunktion_sud4.jpg)
...
![Control command MAISCHE power](../.gitbook/assets/IDS-Sonderfunktion.jpg)
