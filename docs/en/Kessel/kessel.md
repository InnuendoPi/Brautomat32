...
![Kettle configuration](../.gitbook/assets/kessel_2.jpg)
...
![Kettle configuration](../.gitbook/assets/kessel_3.jpg)
...
Without explicit command, mash steps always run on kettle 1 (`MAISCHE`). With command steps, you can control additional kettles. See also: [Mash plan functions](../Maischeplan/funktionen.md).
...
* ON: [http://192.168.1.5/relay/0?turn=on](http://192.168.1.5/relay/0?turn=on)
* OFF: [http://192.168.1.5/relay/0?turn=off](http://192.168.1.5/relay/0?turn=off)
