...
Eksemplene som vises her er bare et lite utvalg ideer. Lenkene peker til eksternt innhold som de respektive tilbyderne er ansvarlige for. Lenkene er ikke knyttet til noe affiliateprogram, handel eller lignende. Du er velkommen til å legge til flere ideer og bilder her.

## Eksempler på skuespillere

### Pumper

![Skuespillere](/docs/img/Pumpe1.jpg)

En pumpe er til stor hjelp når den skal lauteres eller transporteres til gjæringstanken. Pumpen som brukes må være matsikker og egnet for temperaturer opp til 100°C. Minipumpene fra Rotekt egner seg godt til bruk på bryggerikjøkkenet:

![Skuespillere](/docs/img/Pumpe2.jpg)
...
Med Brautomat kan SSR-er byttes veldig enkelt. SSR eller solid state reléer slår 220V AC-kretsen på eller av med 3-5V DC fra Brautomat. Fotek SSR-ene er ideelle for temperaturkontroll og kontroll via Brautomat.
...
Ikke alle forbrukere trenger en kraftig SSR. For eksempel kan aktuatorer som omrørere eller pumper byttes med rimelige relékort. Et veldig bra relékort er Keenso 4-kanals optokobler relékort.
...
Et ringvarmeelement er nyttig ved koking av vørteren hvis ytelsen til GGM IDS ikke lenger er eller bare akkurat nok til å koke vørteren til den bobler. Et godt utvalg av ringvarmeelementer er tilgjengelig fra [Douglas fra Crafthardware](https://www.crafthardware.de/products/ringheizelement-3-5-kw-fuer-45-cm-kessel).
