...
El InnuCase está disponible en dos tamaños. Los archivos de impresión se almacenan en la carpeta Housing/InnuCase.

## Forma del caso

*InnuCaso #1
    > una carcasa más grande con pantalla, dos módulos PWM e interruptor de encendido\
    > Interruptor de encendido para un microcontrolador ESP de fuente de alimentación externa\
    > 1x presostato LED frontal M12, enclavado
    > 2x M12 frontales para actuadores\
    > 2x M12 inferiores para actuadores\
    > 3x M12 inferiores para sensores\
    > Dimensiones de la carcasa AnxAl 26x9cm\
    > Nombre del archivo: InnuCase-1_Display_2PWM_Power.stl\
    ![InnuCase #1](/docs/img/Case-1_Display_2PWM_Power.jpg)\
    > misma carcasa con pantalla y dos módulos PWM sin interruptor de encendido\
    > 2x M12 frontales para actuadores\
    > 2x M12 inferiores para actuadores\
    > 3x M12 inferiores para sensores\
    > Alimentación del microcontrolador ESP mediante GGM IDS\
    > Dimensiones de la carcasa AnxAl 26x9cm\
    > Nombre del archivo: InnuCase-1_Display_2PWM.stl\
    ![InnuCase #1](/docs/img/Case-1_Display_2PWM.jpg)

* InnuCase #1 con un módulo PWM
...
*InnuCaso #2
    > una carcasa más pequeña con pantalla\
    > 1x M12 inferior para sensor\
    > Dimensiones de la carcasa AnxAl 20x9cm\
    > Nombre del archivo: InnuCase-2\
...
*InnuCaso #1
    > una carcasa más grande con pantalla y dos módulos PWM\
    > Dimensiones de la tapa AnxAl 26x9cm\
    > Nombre del archivo: InnuCase-1\
    ![InnuCase #1](/docs/img/Deckel-1_Display_2PWM.jpg)
*InnuCaso #2
    > una carcasa más pequeña con pantalla\
    > Dimensiones de la tapa AnxAl 20x9cm\
    > Nombre del archivo: InnuCase-2\
