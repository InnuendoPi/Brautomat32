...
Vanaf versie 2.5.0 heeft het programma [ kleineBrauhelfer2](https://kleiner-brauhelfer.de/) een exportfilter voor de Brautomat. Met de kleine zethulp2 is receptontwikkeling en -ontwerp tot in elk denkbaar detail mogelijk. Met het spiekbriefje biedt kbh2 een zeer goed en nuttig stroomschema voor praktische implementatie in de brouwerijkeuken. Met het exportfilter voor Brautomat kunnen alle stappen worden uitgevoerd.
...
![Koken](/docs/img/hopfengaben.jpg)
