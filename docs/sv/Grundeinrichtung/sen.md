...
![Skapa sensorer](/docs/img/Sensor-einrichten.jpg)
...
![Konfigurera sensorer](/docs/img/Sensor-einstellungen.jpg)
...
Genom att klicka på _spara_ skapas sensorn och visas sedan i Dashboard under _Sensors_.
