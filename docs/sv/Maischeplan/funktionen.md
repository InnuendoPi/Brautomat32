...
Knapparna för redigering är dolda. För att göra detta synligt igen måste mäskningen stoppas med hjälp av pausknappen på kontrollen:
...
Om autonext avaktiveras i slutet av låset stängs hällen av. Med pausknappen stoppas vilotimern,Men hällen förblir påslagen och Brautomat beräknar den effekt som krävs för hällen.

Följande avsnitt beskriver de valfria specialfunktionerna. Brautomat nybörjare kan hoppa över beskrivningen av specialfunktionerna.
...
![Skådespelarens kontrollkommando](/docs/img/Maischeplan-Aktoren.jpg)
...
Styrkommandot för ett ställdon kan specificeras med en effekt, t.ex. PUMP: 60. Manöverpumpen kopplas sedan på med 60 % effekt. Detta förutsätter att detta ställdon har aktiverats för PWM. Resten temperatur och Rast Duration måste ställas in på 0 för kontrollkommandon.

Styrkommandot IDS:50 ställer in hällens maximala uteffekt till 50 %. Omgjutningen kan även slås på till 75 % effekt med HLT:75.

![IDS-kontrollkommando](/docs/img/sonderfunktion_sud1.jpg)
...
Försockring i mäskningssteget vid 72°C utförs på den första hällen _Maische_. Kontrollenheten PID reglerar den effekt som krävs för mäskkärlet. Samtidigt reglerar regulatorn PID den effekt som krävs för pannan _Sud_.
...
_FörklararFör information om beräkningsmetoden, se: Parametrar för GGM IDS - Temperaturkontroll - Maximal prestanda för IDS._
...
![exempel mash plan bryggdag](/docs/img/example_control_commands1.jpg)
...
Nästa steg är maltosresten. Den PID Styrenheten reglerar den effekt som krävs för att nå måltemperaturen i mäsken och bibehålla den under en period av 40 minuter. På rad 4 slås påfyllningen på med ett speciellt kommando. Måltemperaturen för påfyllningen är 75°C och varaktigheten är 0 minuter. Brautomat startar PID-regulatorn för omgjutning av pannan och reglerar den erforderliga effekten i bakgrunden. Vid denna tidpunkt i mäskplanen är två PID-kontroller aktiva: en PID-kontroller för mäskbryggaren och en PID-kontroller för efterhällningen. Brautomat hoppar direkt till nästa steg efter påslagning.
...
* Varaktighet av mash step hop addition Hall. Tradition 37,2g: 30 minuter
* Varaktighet av mash step hop addition Hall. Tradition 31g: 15 minuter
  * I slutet av detta mossteg, är den första tillsatsen av humle (37,2 g) i vörten i 45 minuter
* Varaktighet av mash step hop addition Hall. Tradition 30g: 10 minuter
  * I slutet av detta mäskningssteg är den första tillsatsen av humle (37,2 g) 55 minuter och den andra är 25 minuter i vörten
* Varaktighet av mash step hop addition Hall. Tradition 7g: 5 minuter
...
![exempel mash plan bryggdag](/docs/img/example_control_commands3.jpg)
...
![exempel mash plan bryggdag](/docs/img/example_control_commands2.jpg)
