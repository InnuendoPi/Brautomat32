...
Exemplen som visas här är bara ett litet urval av idéer. Länkarna pekar på externt innehåll som respektive leverantör ansvarar för. Länkarna är inte länkade till något affiliateprogram, handel eller liknande. Du är välkommen att lägga till fler idéer och bilder här.

## Exempel på skådespelare

### Pumpar

![Skådespelare](/docs/img/Pumpe1.jpg)

En pump är till stor hjälp när man laterar eller transporterar den till jäsningstanken. Pumpen som används måste vara livsmedelssäker och lämplig för temperaturer upp till 100°C. Minipumparna från Rotekt är mycket lämpliga att använda i bryggeriköket:

![Skådespelare](/docs/img/Pumpe2.jpg)
...
Alla konsumenter behöver inte en kraftfull SSR. Till exempel kan manöverdon som omrörare eller pumpar kopplas om med billiga reläkort. Ett mycket bra reläkort är Keenso 4-kanaliga optokopplarreläkort.
...
Ett ringvärmeelement är användbart vid kokning av vörten om prestandan hos GGM IDS inte längre eller bara räcker till för att koka vörten tills den bubblar. Ett bra urval av ringvärmeelement finns tillgängligt från [Douglas från Crafthardware](https://www.crafthardware.de/products/ringheizelement-3-5-kw-fuer-45-cm-kessel).
