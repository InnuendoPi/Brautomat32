...
In addition to the version of Brautomat, the MDNS name and the current IP address are output. The line _mount filesystem LittleFS: ok, free heap mem:_ indicates that the file system has been mounted.
